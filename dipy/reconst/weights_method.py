...
def weights_method_m_est(data, pred_sig, design_matrix, leverages, idx, total_idx, last_robust, m_est="gmm"):
    """
...
weights_method_gm = lambda *args: weights_method_m_est(*args, "gm")
weights_method_cauchy = lambda *args: weights_method_m_est(*args, "cauchy")
